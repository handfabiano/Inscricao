...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Registrar histórico
        registrarHistoricoAtleta($pdo, $atletaId, 'Atualizacao', "Dados do atleta atualizados por " . $_SESSION['admin_nome']);
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" name="ativo" id="ativo"
                                       <?php echo $atleta['ativo'] ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="ativo">
                                    <span class="badge <?php echo $atleta['ativo'] ? 'bg-success' : 'bg-danger'; ?>">
                                        <?php echo $atleta['ativo'] ? 'Ativo' : 'Inativo'; ?>
                                    </span>
                                </label>
                            </div>
                        </div>
        ...
        function verificarIdade() {
            ...
            if (dataNasc) {
                ...
                if (idade < 18) {
                    ...
                    responsavelSection.style.display = '';
                } else {
                    responsavelSection.style.display = '';
                }
            }
